...
export async function pendientesFIFO(proveedorId) {
  ...
  arr.sort((a, b) => {
    const fa = a.fecha_emision && a.fecha_emision.toMillis ? a.fecha_emision.toMillis() : 0;
    const fb = b.fecha_emision && b.fecha_emision.toMillis ? b.fecha_emision.toMillis() : 0;
    return fa - fb;
  });
  return arr;
}
